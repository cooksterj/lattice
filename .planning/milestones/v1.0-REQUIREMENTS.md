# Requirements Archive: v1.0 Multi-Window Asset Monitoring
...
**Adjusted:** AWIN-03 (refocus mechanism changed from window.opener.focus() to named window targeting during Phase 3 human verification)
**Dropped:** None
